...
import profileImage from "../images/info-photo.jpg"
import "../style.css"

function sendEmail(){
    var emailAddress = "parishrishah24@gmail.com";
    var mailToLink = 'mailto:' + emailAddress;
    window.location.href = mailToLink;
}

function goToProfile(){
    var profileURL = "https://www.linkedin.com/in/parishri-shah-0786a9263/"
    ...
    return(
        <div className="info-box">
           ...
           <div>
              ...
              <button className="linkedIn-btn" onClick={goToProfile}> 
